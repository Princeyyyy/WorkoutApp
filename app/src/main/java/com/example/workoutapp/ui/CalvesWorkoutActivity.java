...
public class CalvesWorkoutActivity extends AppCompatActivity {
    public static final String TAG = CalvesWorkoutActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<Workout> call = client.getWorkouts(14);
        ...
        call.enqueue(new Callback<Workout>() {
            ...
            public void onResponse(Call<Workout> call, Response<Workout> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    mAdapter = new RecyclerViewAdapter(CalvesWorkoutActivity.this, results);
                    mRecyclerView.setAdapter(mAdapter);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(CalvesWorkoutActivity.this);
