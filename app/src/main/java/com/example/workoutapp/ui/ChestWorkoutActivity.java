...
//                }
                ...
                if (response.isSuccessful()) {
                    ...
                    mAdapter = new RecyclerViewAdapter(ChestWorkoutActivity.this, results);
                    mRecyclerView.setAdapter(mAdapter);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(ChestWorkoutActivity.this);
