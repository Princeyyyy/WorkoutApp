...
public class LegsWorkoutActivity extends AppCompatActivity {
    public static final String TAG = LegsWorkoutActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<Workout> call = client.getWorkouts(9);
        ...
        call.enqueue(new Callback<Workout>() {
            ...
            public void onResponse(Call<Workout> call, Response<Workout> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(LegsWorkoutActivity.this);
